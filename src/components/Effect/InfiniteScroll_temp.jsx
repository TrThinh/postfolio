...
export default function InfiniteScroll({
  ...
  maxHeight = "80%",          // Max-height of the outer wrapper
  ...
  autoplaySpeed = 0.2,          // Speed (pixels/frame approx.)
  ...
  return (
    <div
      ...
      style={{ maxHeight }}
    >
      <div className="absolute top-0 left-0 w-full h-1/4 bg-gradient-to-b from-purple500 to-transparent z-10 pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-full h-1/4 bg-gradient-to-t from-purple500 to-transparent z-10 pointer-events-none"></div>
      ...
      >
        {items.map((item, i) => (
          <div
            className="flex items-center justify-center p-4 text-2xl font-semibold text-center border-2 border-purple300 rounded-[15px] select-none box-border relative"
            key={i}
            style={{
